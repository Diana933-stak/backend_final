...
$app->get('/', static fn (ServerRequestInterface $request, Response $response) => ApiResponse::success($response, ['service' => 'ms-conductores'], 'Microservicio de conductores activo'));
