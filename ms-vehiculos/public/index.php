...
$app->get('/', static fn (ServerRequestInterface $request, Response $response) => ApiResponse::success($response, ['service' => 'ms-vehiculos'], 'Microservicio de vehiculos activo'));
